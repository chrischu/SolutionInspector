...
Shared\Build\OutputSplitter.exe "powershell" "-NonInteractive -Command "" & { . .\Build.ps1 -Mode "Local" -Version ""0.0.1"" -CommitHash ""%commitHash%"" -CreateNuGetPackages $True -CreateArchives $True }""" "Build.log"
