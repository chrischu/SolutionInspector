...
{
  [Subject (typeof(ProjectItemMustBeIncludedByWildcardRule))]
  class ProjectItemMustBeIncludedByWildcardRuleSpec
  {
    static IProjectItem ProjectItem;
    static IProject Project;

    static ProjectItemMustBeIncludedByWildcardRule SUT;
    ...
    Establish ctx = () =>
    {
      ...
      SUT = new ProjectItemMustBeIncludedByWildcardRule();
    };
    ...
    class when_evaluating_and_item_is_not_included_by_wildcard
    {
      ...
      It returns_violation = () =>
          Result.ShouldAllBeLike(new RuleViolation(SUT, ProjectItem, "Project item 'Item' must be included via wildcard."));
