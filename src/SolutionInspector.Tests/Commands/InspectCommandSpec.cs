...
namespace SolutionInspector.Tests.Commands
{
  ...
  class InspectCommandSpec
  {
    ...
    Establish ctx = () =>
    {
      ...
      A.CallTo(() => ConfigurationLoader.LoadRulesConfig(A<string>._)).Returns(SolutionInspectorRuleset);
      ...
      SUT = new InspectCommand(
          ...
          SolutionInspectorConfiguration);
    };
    ...
    class when_running_with_Solution_configuration_file
    {
      ...
      It loads_configuration = () =>
          A.CallTo(() => ConfigurationLoader.LoadRulesConfig($"solution.{SolutionInspector.RulesetFileExtension}")).MustHaveHappened();
    ...
    class when_running_with_other_configuration_file
    {
      ...
      It loads_configuration = () =>
          A.CallTo(() => ConfigurationLoader.LoadRulesConfig("file")).MustHaveHappened();
    ...
    {
      Establish ctx =
          () => { A.CallTo(() => ConfigurationLoader.LoadRulesConfig(A<string>._)).Throws(new FileNotFoundException("NOTFOUND")); };
    ...
    class when_running_and_configuration_file_loading_fails
    {
      Establish ctx = () =>
      {
        ...
        A.CallTo(() => ConfigurationLoader.LoadRulesConfig(A<string>._)).Throws(ThrownException);
      };
    ...
    class when_running_with_non_existing_solution
    {
      ...
      It loads_configuration = () =>
          A.CallTo(() => ConfigurationLoader.LoadRulesConfig($"DOES_NOT_EXIST.{SolutionInspector.RulesetFileExtension}")).MustHaveHappened();
