...
Build\OutputSplitter.exe "powershell" "-NonInteractive -Command "" & { . .\Build.ps1 -Mode "Local" -Version ""0.0.0"" -CommitHash ""%commitHash%"" -RunFxCopCodeAnalysis $False -RunReSharperCodeInspection $False }""" "Build.log"
